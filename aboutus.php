...
<html lang = "en">
	<head>
		<title>Hotel M & M Online Reservation</title>
		<meta charset = "utf-8" />
	...
	<nav style = "background-color:rgba(0, 0, 0, 0.1);" class = "navbar navbar-default">
		<div  class = "container-fluid">
			<div class = "navbar-header">
				<a class = "navbar-brand" >Hotel M & M Online Reservation</a>
			</div>
		</div>
	</nav>	
	<ul id = "menu">
		...
		<li><a href = "dineandlounge.php">Resturant</a></li> |			
		<li><a href = "reservation.php">Reservation</a></li> |
		<li><a href = "rulesandregulation.php">Policy</a></li>
	</ul>
	<div style = "margin-left:0;" class = "container">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<strong><h3>ABOUT US</h3></strong>
				<p style = "position:relative; float:left; width:850px;">
Welcome to M & M Hotels, where hospitality meets excellence. Nestled in prime locations, our boutique hotels offer a seamless blend of luxury and comfort. With a commitment to personalized service, we strive to create memorable experiences for every guest. Discover contemporary elegance, attentive staff, and a welcoming atmosphere that sets M & M Hotels apart. Whether for business or leisure, make your stay extraordinary with us.</p>
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label></label> <label style = "color:red;">$ 25.00</label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label style = "color:red;">$ 25.00</label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label></label> <label style = "color:red;">$ 45.00 </label></center>
				</div>
				<br style = "clear:both;"/>
				<br />
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label></label> <label style = "color:red;">$ 55.00 </label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label></label> <label style = "color:red;">$ 90.00 </label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label></label> <label style = "color:red;">$ 110.00 </label></center>
				</div>
				<br style = "clear:both;"/>
				<br />
				<br />
	...
	<div style = "text-align:right; margin-right:10px;" class = "navbar navbar-default navbar-fixed-bottom">
		<label>&copy; Copyright M & M 2023 </label>
	</div>
</body>
